...
import com.pagefactory.Pagefactory91;
...
public class StepsDef91 {
	WebDriver driver;
	ArrayList<String> list;
	Pagefactory91 pageFact;
	
	@Given("^user go to your logo site$")
	public void user_go_to_your_logo_site() throws Throwable {
	...
	public void user_click_on_the_dresses_tab() throws Throwable {
		//driver.findElement(By.xpath("(//*[contains(text(),'Dresses')])[5]")).click();
				pageFact = new Pagefactory91(driver);
	}

	@When("^user capture all dress price from resultset$")
	public void user_capture_all_dress_price_from_resultset() throws Throwable {
		List<WebElement> allDreses = driver
				.findElements(By.xpath("//*[@class='product-container']/div[2]/div[1]/span[1]"));
